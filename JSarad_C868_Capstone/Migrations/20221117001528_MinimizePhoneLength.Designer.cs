...
namespace JSarad_C868_Capstone.Migrations
{
    ...
    [Migration("20221117001528_MinimizePhoneLength")]
    partial class MinimizePhoneLength
    {
            ...
            modelBuilder.Entity("JSarad_C868_Capstone.Models.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastUpdate = new DateTime(2022, 11, 16, 16, 15, 27, 857, DateTimeKind.Local).AddTicks(1761),
                            Name = "Edwin Ledford",
                            Phone = "6613332222"
                        });
                });
            ...
            modelBuilder.Entity("JSarad_C868_Capstone.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastUpdate = new DateTime(2022, 11, 16, 16, 15, 27, 857, DateTimeKind.Local).AddTicks(1794),
                            Name = "Johanna Sarad",
                            Phone = "6614444763",
                            Role = "Bartender"
                        },
                        new
                        {
                            ...
                            LastUpdate = new DateTime(2022, 11, 16, 16, 15, 27, 857, DateTimeKind.Local).AddTicks(1797),
                        ...
                        new
                        {
                            ...
                            LastUpdate = new DateTime(2022, 11, 16, 16, 15, 27, 857, DateTimeKind.Local).AddTicks(1799),
                            Name = "Ian Ward",
                            Phone = "8057778899",
                            Role = "Server"
                        });
            ...
            modelBuilder.Entity("JSarad_C868_Capstone.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Food = true,
                            Guests = 50,
                            LastUpdate = new DateTime(2022, 11, 16, 16, 15, 27, 857, DateTimeKind.Local).AddTicks(1810),
